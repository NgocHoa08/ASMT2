...
if ($category && in_array($category, ['candy', 'cake'])) {
    $sql .= " AND category = ?";
    $params[] = $category;
    $types .= "s";
}
...
$sql = "SELECT id, name, price, image FROM products ORDER BY id DESC LIMIT 3";
                        ...
                        <form class="category-filter" method="GET" action="product.php">
                            <div class="input-group">
                                <select name="category" class="form-select" onchange="this.form.submit()">
                                    ...
                                    <option value="candy" <?php echo $category === 'candy' ? 'selected' : ''; ?>>Bánh kẹo</option>
                                    <option value="cake" <?php echo $category === 'cake' ? 'selected' : ''; ?>>Các loại bánh</option>
                                </select>
                                <?php if ($search): ?>
